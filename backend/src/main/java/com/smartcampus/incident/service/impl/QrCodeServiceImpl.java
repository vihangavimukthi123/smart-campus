...
public class QrCodeServiceImpl implements QrCodeService {
    ...
    public String generateQrCodeImage(String token) {
        try {
            String baseUrl = (frontendUrl == null || frontendUrl.isEmpty()) ? "http://localhost:5173" : frontendUrl;
            String verificationUrl = String.format("%s/booking-details/%s", baseUrl, token);
