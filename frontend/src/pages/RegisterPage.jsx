        ...
        {!showOtp ? (
          <>
            ...
            <form onSubmit={submitRegistration} autoComplete="off">
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1rem" }}>
                <div className="form-group">
                  <label className="form-label">Phone (10 digits) <span style={{ color: 'var(--clr-error)' }}>*</span></label>
                  <input className="form-input" type="text" placeholder="0712345678" maxLength={10}
                    value={form.phone}
                  ...
                  {ROLES.map((r) => (
                    ...
                    >
                      <input type="radio" name="role" value={r} checked={form.role === r}
                        onChange={() => set("role", r)} style={{ display: "none" }} />
                      <span style={{ fontSize: '1.15rem' }}>{r === "USER" ? "👤" : "🔧"}</span>
              ...
              <button type="submit" className="btn btn-primary btn-lg"
                style={{ width: "100%", marginTop: "0.25rem" }} disabled={loading}>
                {loading
          ...
          <div className="otp-view">
            ...
            <form onSubmit={submitVerify}>
              <input
                ...
                required
              />
              <p className={`otp-timer${timer === 0 ? ' otp-timer--expired' : ' otp-timer--active'}`}>
                {timer > 0 ? `Expires in ${formatTime(timer)}` : 'Code expired — request a new one'}
              </p>
              <button type="submit" className="btn btn-primary btn-lg"
            ...
            <button
              ...
              disabled={timer > 0}
              style={{
                background: "none", border: "none", marginTop: "1rem",
